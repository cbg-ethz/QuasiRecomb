...
//                System.out.println("Max: " + max);
                ...
                System.out.println(sb.toString());
//                System.out.println(IntersectQuasispecies.compute(this.input, this.input2).toString());
//            } else if (this.circos) {
...
//                }
                ...
                Globals.getINSTANCE().setSPIKE_RHO(this.spikeRho);
                Globals.getINSTANCE().setSPIKE_MU(this.spikeMu);
